...
im = Image.open('map2.gif')  # На всякий случай делать вот так через модуль PIL (Pillow).
                            # Если он вдруг не установлен у учеников,
                            # то его надо будет установить
im.save('map5.gif')  # Такой подход работает. Если напрямую вписать имя файла в bgpic, то может
                    # появиться ошибка чтения
screen.bgpic('map5.gif')  # Функция bgpic поодерживает только gif файлы
"""
